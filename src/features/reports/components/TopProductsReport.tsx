              ...
              <tr>
                <td colSpan={5} className="p-0">
                  <div className="bg-white">
                    <EmptyState
                      icon={Pill}
                      title="Aucun produit vendu pour le moment"
                      description="Le classement des produits les plus vendus s'affichera ici dès que vous aurez enregistré des ventes."
                    />
                  </div>
                </td>
              </tr>
